  ...
  return (
    <div className="device-screen" style={{ opacity: exiting ? 0 : 1, transition: 'opacity 0.4s' }}>
      ...
      <div style={{ position: 'relative', zIndex: 5, padding: '0 28px', flex: 1, display: 'flex', flexDirection: 'column' }}>
        ...
        {/* CTA */}
        <button className="btn btn-volt" onClick={handle} style={{ width: '100%', height: 64, fontSize: 14, animation: 'slideUp 0.7s 0.35s both', animation: 'slideUp 0.7s 0.35s both, pulseVolt 2.5s 1.5s infinite' }}>
...
// HOME SCREEN
// ============================================
function HomeScreen({ user, theme, onToggleTheme, onShowQR, weeklyVolume }) {
  return (
...
window.AccessFAB = AccessFAB;

// ============================================
// QR OVERLAY
// ============================================
function QROverlay({ user, onClose }) {
  return (
